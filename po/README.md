# How to Translate inscriptions

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/elly_code/inscriptions```
...
And that's it! You've successfully translated inscriptions for your language!
